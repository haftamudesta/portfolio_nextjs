                ...
                >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 ">
                                {projects.map((project,index)=>(
                                        ...
                                        className="relative h-[700px] rounded-4xl overflow-hidden bg-gray-400 border border-white/80 cursor-pointer"
                                        >
                                                <motion.div
                                                ...
                                                >
                                                        ...
                                                        <h1 className='text-2xl text-sky-700 font-semibold mb-2'>Technologies Used</h1>
