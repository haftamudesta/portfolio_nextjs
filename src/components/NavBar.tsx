...
export const NavBar = () => {
        ...
        return (
          <main>
            <motion.nav
              className="fixed w-[400px] sm:w-full z-50 bg-gradient-to-r from-blue-800 to-blue-950 text-white shadow-lg"
              id='navbar'
            >
...
//      <main>
//     <motion.nav
//      className="fixed w-full z-50 bg-linear-45 from-blue-800 to-blue-950 transition-all duration-300 ease-out text-white shadow-lg overflow-hidden"
//      id='navbar'
//     >
//         <div className="flex max-w-7xl mx-auto px-6 py-3 items-center justify-between">
//         <div className="flex items-center gap-8">
...
//         className='fixed md:hidden z-40 inset-0 pt-16 bg-blue-900/95 backdrop-blur-sm'
//         >
//                 {navLinks.map((item,i)=>(
//                         <a key={i} href={item.href}
//                         onClick={()=>setIsOpenMenu(false)}
//                         className='block px-4 py-3 text-white/90 hover:text-white hover:bg-white/10 rounded-lg transition-colors capitalize font-bold text-x'
//                         >
//                                 {item.name}
//                         </a>
//                 ))}
